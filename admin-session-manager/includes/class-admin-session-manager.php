...
class Admin_Session_Manager {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Admin_Session_Manager_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'ADMIN_SESSION_MANAGER_VERSION' ) ) {
			$this->version = ADMIN_SESSION_MANAGER_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'asm';
	...
	private function load_dependencies() {
		...
		$this->loader = new Admin_Session_Manager_Loader();
	...
	private function set_locale() {
		...
		$plugin_i18n = new Admin_Session_Manager_i18n();
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Admin_Session_Manager_Admin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Admin_Session_Manager_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Admin_Session_Manager_Loader    Orchestrates the hooks of the plugin.
	 */
