            ...
            if ( ! empty( $comments ) ) {
                foreach ( $comments as $comment ) {
                    $live_comments[] = array(
                        ...
                        'content' => $this->wpla_trim_string(wp_strip_all_tags($comment->comment_content), 50, '..'),
                        'date' => $comment->comment_date,
                        'date_gmt' => $comment->comment_date_gmt,
                        'parent' => $comment->comment_parent,
                        'post_ID' => $comment->comment_post_ID,
                        'post_title' => $this->wpla_trim_string(get_the_title($comment->comment_post_ID), 25, '..'),
